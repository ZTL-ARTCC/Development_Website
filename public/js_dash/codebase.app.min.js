        ...
        return a = e, t = null, n = [{
            ...
            key: "coreAppear", value: function () {
                jQuery('[data-toggle="appear"]:not(.js-appear-enabled)').each(function (e, a) {
                    var t = o.getWidth(), n = jQuery(a), r = n.data("class") || "animated fadeIn",
                        l = n.data("offset") || 0, i = t < 992 ? 0 : n.data("timeout") ? n.data("timeout") : 0;
            ...
            key: "contentFilter", value: function () {
                jQuery(".js-filter:not(.js-filter-enabled)").each(function (e, a) {
                    var t, n = jQuery(a), r = jQuery(".nav-pills", n), l = jQuery("a[data-category-link]", n),
        ...
        return a = e, (t = [{
            ...
            key: "_uiHandleTheme", value: function () {
                ...
                jQuery('[data-toggle="theme"][data-theme="' + (e.length ? e.attr("href") : "default") + '"]').parent("li").addClass("active"), this._lPage.off("click.cb.themes"), this._lPage.on("click.cb.themes", '[data-toggle="theme"]', function (t) {
                    t.preventDefault();
                    var n = jQuery(t.currentTarget), r = n.data("theme");
                    jQuery('[data-toggle="theme"]').parent("li").removeClass("active"), jQuery('[data-toggle="theme"][data-theme="' + r + '"]').parent("li").addClass("active"), o.updateTheme(e, r), e = jQuery("#css-theme"), a && Cookies.set("cbThemeName", r, {expires: 7}), n.blur()
                })
            }
        }, {
            ...
            key: "_uiApiBlocks", value: function () {
                var e, a, t, n = this, o = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
                    r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "init", l = this,
