...
@section('content')
    ...
    <main id="main-container">
        ...
        <!-- Page Content -->
        <div class="content">
            <div class="row gutters-tiny invisible" data-toggle
            "appear">
            <!-- Row #1 -->
                ...
                <div class="block block-transparent bg-primary-dark d-flex align-items-center w-100">
                        ...
                        <div class="py-15 px-20 clearfix border-black-op-b">
                            ...
                            @if($personal_stats->total_hrs < 0)
                                <div class="font-size-h3 font-w600 text-success" data-toggle="countTo" data-speed="1000"
                                     data-to="{{ $personal_stats->total_hrs }}">
                                    @else
                                        0
                                    @endif</div>
                    ...
                    <div class="py-15 px-20 clearfix border-black-op-b">
                        ...
                        <div class="font-size-h3 font-w600 text-warning" data-toggle="countTo" data-speed="1000"
                             data-to="	@if(!empty($stats['total']))
                             {{{ $stats['total'] }}}
                             @else
                                 0
@endif">0
                        </div>
                        <div class="font-size-sm font-w600 text-uppercase text-warning-light">Total Controlling Hours
                        </div>
                    </div>
