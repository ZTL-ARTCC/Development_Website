...
@section('content')
    ...
    <!-- Hero -->
    <div class="bg-image bg-image-bottom" style="background-image: url('/assets_new/img/photos/controllers.jpg');">
                            ...
                            @forelse($homeControllers as $h)
                                <tr>
                                    @if(Auth::check())
                                        @if(Auth::user()->can('roster'))
                                            <td class="text-center"><a
                                                    href="/dashboard/admin/roster/edit/{{$h->id}}">{{{$h->backwards_name}}}</a>
                                            </td>
                                        @else
                                    ...
                                    <td class="text-center">
                                        @if($h->loa == '1') <span class="badge badge-info">Leave</span> @else <span
                                    ...
                                    <td class="text-center">@if($h->del == '0') <span
                                            class="badge badge-secondary">None</span> @elseif($h->del == '1') <span
                                            class="badge badge-warning">Minor</span> @elseif($h->del == '2')<span
                                            class="badge badge-success">Major</span>@endif</td>

                                    <td class="text-center">@if($h->gnd == '0') <span
                                            class="badge badge-secondary">None</span> @elseif($h->gnd == '1') <span
                                            class="badge badge-warning">Minor</span> @elseif($h->gnd == '2')<span
                                            class="badge badge-success">Major</span>@endif</td>

                                    <td class="text-center">@if($h->twr == '0') <span
                                            class="badge badge-secondary">None</span> @elseif($h->twr == '1') <span
                                            class="badge badge-warning">Minor</span> @elseif($h->twr == '2')<span
                                            class="badge badge-success">Major</span> @elseif($h->twr == '99') <span
                                            class="badge badge-warning">Solo</span>@endif</td>

                                    <td class="text-center">@if($h->app == '0') <span
                                            class="badge badge-secondary">None</span> @elseif($h->app == '1') <span
                                            class="badge badge-warning">Minor</span> @elseif($h->app == '2') <span
                                            class="badge badge-success">Major</span> @elseif($h->app == '99') <span
                                            class="badge badge-warning">Solo</span>@endif</td>

                                    <td class="text-center">@if($h->ctr == '0') <span
                                            class="badge badge-secondary">None</span> @elseif($h->ctr == '2') <span
                                            class="badge badge-warning">Training</span> @elseif($h->ctr == '1')
                                            <span class="badge badge-success">Major</span> @elseif($h->ctr == '99')
                                            <span class="badge badge-warning">Solo</span> @endif</td>
                                </tr>
                            @empty
                            @endforelse
                            </tbody>
