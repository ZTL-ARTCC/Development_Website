...
@section('content')
    ...
    <div class="content">
            ...
            <div class="col-4 col-xl-4">
                <a class="block block-link-pop text-right bg-gd-emerald">
                    <div class="block-content block-content-full clearfix border-black-op-b border-3x">
                        ...
                        <div class="font-size-sm font-w600 text-uppercase text-white-op"><?php echo date("F"); ?> MTD
                            Hours
                        </div>
                    </div>
                </a>
            ...
            <div class="col-4 col-xl-4">
                <a class="block block-link-pop text-right bg-gd-leaf">
                    <div class="block-content block-content-full clearfix border-black-op-b border-3x">
                        ...
                        <div class="font-size-sm font-w600 text-uppercase text-white-op"><?php echo date("Y"); ?> YTD
                            Hours
                        </div>
                    </div>
                </a>
        ...
        <div class="row">
            <div class="col-lg-12">
                <a href="/stats/<?=$pyr?>/<?=$pm?>">
                    <button type="button" class="btn btn-rounded btn-secondary min-width-125 mb-10"><i
                            class="fa fa-fw fa-backward mr-5"></i>Previous Month
                    </button>
                </a>
                <div style="float: right;"><a href="/stats/<?=$nyr?>/<?=$nm?>">
                        <button type="button" class="btn btn-rounded btn-secondary min-width-125 mb-10"><i
                                class="fa fa-fw fa-forward mr-5"></i> Next Month
                        </button>
                    </a></div>
                <!-- Main Stats Tabs -->
                <div class="block">
