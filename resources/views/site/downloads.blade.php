                            ...
                            <div class="col-md-6 col-xl-6" data-category="vrc">
                                <a class="block block-rounded block-link-shadow" href="{{ $v->path }}">
                                    <div class="block-content block-content-full text-center">
                                        <div
                                            class="item item-2x item-circle bg-success-light text-success mx-auto my-20">
                                            VRC
                                        </div>
                                        <div class="block-content block-content-full bg-body-light text-center">
                                            <div class="font-size-lg">{{{$v->name}}}</div>
                                            <div class="font-size-sm text-muted">Last Update: {{{$v->updated_at}}}z
                                            </div>
                                            @if(empty($v->comments))
                        ...
                        @foreach ($veram as $v)
                            <div class="col-md-6 col-xl-6" data-category="veram">
                                <a class="block block-rounded block-link-shadow" href="{{ $v->path }}">
                                    <div class="block-content block-content-full text-center">
                                        <div
                                            class="item item-2x item-circle bg-warning-light text-warning mx-auto my-20">
                                            vERAM
                                        </div>
                                        <div class="block-content block-content-full bg-body-light text-center">
                                            <div class="font-size-lg">{{{$v->name}}}</div>
                        ...
                        @foreach ($vatis as $v)
                            <div class="col-md-6 col-xl-6" data-category="vatis">
                                <a class="block block-rounded block-link-shadow" href="{{ $v->path }}">
                                    <div class="block-content block-content-full text-center">
                                        <div
                                            class="item item-2x item-circle bg-secondary text-secondary-light mx-auto my-20">
                                            vATIS
                                        </div>
                                        <div class="block-content block-content-full bg-body-light text-center">
                                            <div class="font-size-lg">{{{$v->name}}}</div>
                                ...
                                <a class="block block-rounded block-link-shadow" href="{{ $s->path }}">
                                    <div class="block-content block-content-full text-center">
                                        ...
                                        <div class="block-content block-content-full bg-body-light text-center">
                                            ...
                                            <div class="font-size-sm text-muted">Last Update: {{{$s->updated_at}}}z
                                            </div>
                                            @if(empty($s->comments))
                                                <div class="font-size-sm text-muted">No description available.</div>
                                            @else
