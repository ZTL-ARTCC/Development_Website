...
@section('content')
    ...
    <!-- Hero -->
    <div class="bg-image bg-image-bottom" style="background-image: url('/assets_new/img/photos/events.jpg');">
                    ...
                    <div class="card-header">
                        <h3>
                            ...
                            @if(Auth::user()->can('events'))
                                @if($event->reg == 0)
                                    <a href="/admin/events/toggle-reg/{{ $event->id }}"
                            ...
                            @if($positions->count() > 0)
                                @foreach($positions as $p)
                                    <tr>
                                        ...
                                        @if(Auth::user()->can('events'))
                                            <td>
                                                <a href="/admin/events/position/delete/{{ $p->id }}"
                        ...
                        @if($positions->count() > 0)
                            ...
                            @if(Auth::guest())
                                ...
                                @if($event->reg == 1 && Auth::user()->canEvents == 1)
                                    ...
                                    <div class="form-group inline">
                                        ...
                                        @if($your_registration1)
                                            <a href="/events/view/{{ $your_registration1->id }}/un-signup"
                            ...
                            @if(Auth::user()->can('events'))
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                        <button type="submit" class="btn btn-success simple-tooltip"
                                                data-toggle="tooltip" title="Add Position"><i class="fas fa-check"></i>
                                        </button>
                                    </div>
                                </div>
                                {!! Form::close() !!}
