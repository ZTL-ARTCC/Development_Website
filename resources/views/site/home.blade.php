							...
							<div class="row">
								...
								@if (count($currentTop3) == 3)
									@foreach($currentTop3 as $controller)
										<?php $pos++ ?>
										@if ($pos == 1)
											@if($controller->path != null)<div class="col-md-6 col-xl-4"><a class="block block-link-pop bg-gd-sun text-center"><div class="block-content block-content-full"><img class="img-avatar" src="/storage/files/<?php echo $controller->path; ?>.jpg" alt="Profile Picture"></div><div class="block-content block-content-full bg-black-op-5"><div class="font-w600 text-white mb-5">{{{ $controller->fname . " " . $controller->lname }}}</div><div class="font-size-sm text-white-op">{{{ $controller->duration_time }}}</div></div><div class="block-content block-content-full block-content-sm"><span class="font-w600 font-size-sm text-warning-light"><i class="fa fa-hourglass mr-10"></i>First Place</span></div></a></div>
											@else <div class="col-md-6 col-xl-4"><a class="block block-link-pop bg-gd-sun text-center"><div class="block-content block-content-full"><img class="img-avatar" src="/assets_new/img/avatars/avatar0.jpg" alt="Profile Picture"></div><div class="block-content block-content-full bg-black-op-5"><div class="font-w600 text-white mb-5">{{{ $controller->fname . " " . $controller->lname }}}</div><div class="font-size-sm text-white-op">{{{ $controller->duration_time }}}</div></div><div class="block-content block-content-full block-content-sm"><span class="font-w600 font-size-sm text-warning-light"><i class="fa fa-hourglass mr-10"></i>First Place</span></div></a></div>
											@endif
										@elseif ($pos == 2)
											@if($controller->path != null)<div class="col-md-6 col-xl-4"><a class="block block-link-pop bg-muted text-center"><div class="block-content block-content-full"><img class="img-avatar" src="/storage/files/<?php echo $controller->path; ?>.jpg" alt="Profile Picture"></div><div class="block-content block-content-full bg-black-op-5"><div class="font-w600 text-white mb-5">{{{ $controller->fname . " " . $controller->lname }}}</div><div class="font-size-sm text-white-op">{{{ $controller->duration_time }}}</div></div><div class="block-content block-content-full block-content-sm"><span class="font-w600 font-size-sm text-white-op"><i class="fa fa-hourglass-half mr-10"></i>Second Place</span></div></a></div>
											@else <div class="col-md-6 col-xl-4"><a class="block block-link-pop bg-muted text-center"><div class="block-content block-content-full"><img class="img-avatar" src="/assets_new/img/avatars/avatar0.jpg" alt="Profile Picture"></div><div class="block-content block-content-full bg-black-op-5"><div class="font-w600 text-white mb-5">{{{ $controller->fname . " " . $controller->lname }}}</div><div class="font-size-sm text-white-op">{{{ $controller->duration_time }}}</div></div><div class="block-content block-content-full block-content-sm"><span class="font-w600 font-size-sm text-white-op"><i class="fa fa-hourglass-half mr-10"></i>Second Place</span></div></a></div>
											@endif
										@elseif ($pos == 3)
											@if($controller->path != null)<div class="col-md-6 col-xl-4"><a class="block block-link-pop bg-elegance-dark text-center"><div class="block-content block-content-full"><img class="img-avatar" src="/storage/files/<?php echo $controller->path; ?>.jpg" alt="Profile Picture"></div><div class="block-content block-content-full bg-black-op-5"><div class="font-w600 text-white mb-5">{{{ $controller->fname . " " . $controller->lname }}}</div><div class="font-size-sm text-white-op">{{{ $controller->duration_time }}}</div></div><div class="block-content block-content-full block-content-sm"><span class="font-w600 font-size-sm text-white-op"><i class="fa fa-hourglass-o mr-10"></i>Third Place</span></div></a></div>
											@else <div class="col-md-6 col-xl-4"><a class="block block-link-pop bg-elegance-dark text-center"><div class="block-content block-content-full"><img class="img-avatar" src="/assets_new/img/avatars/avatar0.jpg" alt="Profile Picture"></div><div class="block-content block-content-full bg-black-op-5"><div class="font-w600 text-white mb-5">{{{ $controller->fname . " " . $controller->lname }}}</div><div class="font-size-sm text-white-op">{{{ $controller->duration_time }}}</div></div><div class="block-content block-content-full block-content-sm"><span class="font-w600 font-size-sm text-white-op"><i class="fa fa-hourglass-o mr-10"></i>Third Place</span></div></a></div>
											@endif
										@endif
									@endforeach
