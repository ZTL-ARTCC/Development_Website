        ...
        <div class="bg-image" style="background-image: url('/assets_new/img/photos/fpage.jpg')">
            <div class="hero bg-black-op-25">
                <div class="hero-inner">
                    <div class="content content-full text-center">
                        <h1 class="display-3 font-w700 text-white mb-10 invisible" data-toggle="appear"
                            data-class="animated fadeInDown">Welcome Back to Atlanta, {{Auth::user()->fname}}.</h1>
                        <h2 class="font-w400 text-white-op mb-50 invisible" data-toggle="appear"
                            data-class="animated fadeInDown">

                            <a class="btn btn-hero btn-noborder btn-rounded btn-primary mb-10 invisible"
                               data-toggle="appear" data-class="animated fadeInUp" href="/profile">
    ...
    <div class="content">
        ...
        <div class="row items-push py-30">
            <div class="col-xl-8">
                ...
                <h2 class="content-heading-hp">Top <?php echo date("F"); ?> Controllers <small>By number of
                        hours.</small></h2>
                <div class="row">
                    <?php $pos = 0 ?>
                        ...
                        @foreach($currentTop3 as $controller)
                            ...
                            @if ($pos == 1)
                                @if($controller->path != null)
                                    <div class="col-md-6 col-xl-4"><a
                                            class="block block-link-pop bg-gd-sun text-center">
                                            <div class="block-content block-content-full"><img class="img-avatar"
                                                                                               src="<?php echo $controller->path; ?>.jpg"
                                                                                               alt="Profile Picture">
                                            </div>
                                            <div class="block-content block-content-full bg-black-op-5">
                                                <div
                                                    class="font-w600 text-white mb-5">{{{ $controller->fname . " " . $controller->lname }}}</div>
                                                <div
                                                    class="font-size-sm text-white-op">{{{ $controller->duration_time }}}</div>
                                            </div>
                                            <div class="block-content block-content-full block-content-sm"><span
                                                    class="font-w600 font-size-sm text-warning-light"><i
                                                        class="fa fa-hourglass mr-10"></i>First Place</span></div>
                                        </a></div>
                                @else
                                    <div class="col-md-6 col-xl-4"><a
                                            class="block block-link-pop bg-gd-sun text-center">
                            ...
                            @elseif ($pos == 2)
                                @if($controller->path != null)
                                    <div class="col-md-6 col-xl-4"><a class="block block-link-pop bg-muted text-center">
                                            <div class="block-content block-content-full"><img class="img-avatar"
                                                                                               src="<?php echo $controller->path; ?>.jpg"
                                                                                               alt="Profile Picture">
                                            </div>
                                            ...
                                            <div class="block-content block-content-full block-content-sm"><span
                                                    class="font-w600 font-size-sm text-white-op"><i
                                                        class="fa fa-hourglass-half mr-10"></i>Second Place</span>
                                            </div>
                                        </a></div>
                                @else
                                    <div class="col-md-6 col-xl-4"><a class="block block-link-pop bg-muted text-center">
                            ...
                            @elseif ($pos == 3)
                                @if($controller->path != null)
                                    <div class="col-md-6 col-xl-4"><a
                                            class="block block-link-pop bg-elegance-dark text-center">
                                            <div class="block-content block-content-full"><img class="img-avatar"
                                                                                               src="<?php echo $controller->path; ?>.jpg"
                                                                                               alt="Profile Picture">
                                            </div>
                                            ...
                                            <div class="block-content block-content-full block-content-sm"><span
                                                    class="font-w600 font-size-sm text-white-op"><i
                                                        class="fa fa-hourglass-o mr-10"></i>Third Place</span></div>
                                        </a></div>
                                @else
                                    <div class="col-md-6 col-xl-4"><a
                                            class="block block-link-pop bg-elegance-dark text-center">
                    ...
                    @elseif (count($currentTop3) == 2)
                        @foreach($currentTop3 as $controller)
                            <?php $pos++ ?>
                            @if ($pos == 1)
                                <div class="col-md-6 col-xl-6"><a class="block block-link-pop bg-gd-sun text-center">
                                        <div class="block-content block-content-full"><img class="img-avatar"
                                                                                           src="/assets_new/img/avatars/avatar8.jpg"
                            ...
                            @elseif ($pos == 2)
                                <div class="col-md-6 col-xl-6"><a class="block block-link-pop bg-muted text-center">
                                        <div class="block-content block-content-full"><img class="img-avatar"
                                                                                           src="/assets_new/img/avatars/avatar8.jpg"
                                                                                           alt="Profile Picture"></div>
                                        <div class="block-content block-content-full bg-black-op-5">
                                        ...
                                        <div class="block-content block-content-full block-content-sm"><span
                                                class="font-w600 font-size-sm text-white-op"><i
                                                    class="fa fa-hourglass-half mr-10"></i>Second Place</span></div>
                                    </a></div>
                            @endif
                        @endforeach
                    @elseif (count($currentTop3) == 1)
                        @foreach($currentTop3 as $controller)
                            <?php $pos++ ?>
                            @if ($pos == 1)
                                <div class="col-md-6 col-xl-12"><a class="block block-link-pop bg-gd-sun text-center">
                                        <div class="block-content block-content-full"><img class="img-avatar"
                                                                                           src="/assets_new/img/avatars/avatar8.jpg"
                                                                                           alt="Profile Picture"></div>
                                        <div class="block-content block-content-full bg-black-op-5">
                        ...
                        @endforeach
                    @else
                        <div class="col-md-6 col-xl-12"><a class="block block-transparent text-center bg-gd-primary">
                                <div class="block-content bg-black-op-5"><p class="font-w600 text-white">No controllers
                                        have logged hours this month</p></div>
                        ...
                        @forelse ($events as $e)
                            ...
                            @else
                                <div class="col-12">
                                    <div class="block">
                                        <div class="block-content">
                                            <p><img src="{{ $e->banner_path }}" width="500px" alt="{{ $e->name }}"></a>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        @forelse ($events as $e)
                            ...
                            @else
                                <div class="col-12">
                                    <div class="block">
                                        <div class="block-content">
                                            <p><a href="/event/{{{$e->id}}}"><img src="{{ $e->banner_path }}"
                                                                                  width="500px"
                                                                                  alt="{{ $e->name }}"></a></p>
                                        </div>
                                    </div>
