<div class="card bg-light card-body" id="pill-sidebar">
    ...
    <div class="nav flex-column nav-pills" role="tablist" aria-orientation="vertical" style="margin-left:20px;">
        ...
        <div class="content">
            ...
            <script id="setmore_script" type="text/javascript" src="https://ids.ztlartcc.org/"></script>
            <a id="Setmore_button_iframe" class="nav-link" href="https://ids.ztlartcc.org">IDS </a>
        ...
        @if(Auth::user()->canTrain == 1 || Auth::user()->can('train'))
            ...
            <div class="content">
                ...
                <script id="setmore_script" type="text/javascript" src="https://training.ztlartcc.org/"></script>
                <a id="Setmore_button_iframe" class="nav-link" href="https://training.ztlartcc.org/">Schedule a Training
                    Session</a>

                <a class="nav-link {{ Nav::urlDoesContain('dashboard/training/info') }}"
            ...
            <div class="content">
                ...
                @if(Auth::user()->can('email'))
                    ...
                    <a class="nav-link {{ Nav::urlDoesContain('dashboard/admin/email/send') }}"
                       href="/dashboard/admin/email/send">Send New Email</a>
