...
<!--<![endif]-->
    ...
    <body>
                            ...
                            <div class="content-header-section text-center align-parent">
                                ...
                                <div class="content-header-item">
                                    <a class="link-effect font-w700" href="/">
                                        <span class="font-size-xl text-dual-primary-dark">Atlanta</span><span class="font-size-xl text-primary">ARTCC</span>
                                    </a>
                                </div>
                                <!-- END Logo -->
                            </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="font-size-sm mb-30">
                                <ul class="list list-simple-mini font-size-sm">
									...
									<li>
									    <a class="link effect font-w600" href="https://www.vatstar.com/" target="_blank">VATSTAR</a>
									</li>
								</ul>
                            </div>
                        </div>
		...
		<!-- Fade In Modal -->
		<div class="modal fade" id="modal-notice" tabindex="-1" role="dialog" aria-labelledby="modal-notice" aria-hidden="true">
