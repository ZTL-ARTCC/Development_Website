                    ...
                    <table class="table table-outline">
                        ...
                        @foreach($fsx as $s)
                            <tr>
                                <td>
                                    @if($s->image1)
                                        <a href="/dashboard/admin/scenery/view/{{ $s->id }}"><img src="{{ $s->image1 }}"
                                                                                                  width="100px"></img></a>
                                    @else
                                        <img
                                ...
                                <td>
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <a href="/dashboard/admin/scenery/edit/{{ $s->id }}"
                                               class="btn btn-success simple-tooltip" data-toggle="tooltip"
                                               title="Edit Scenery"><i class="far fa-edit"></i></a>
                                        </div>
                                        <div class="col-sm-2">
                                            {!! Form::open(['action' => ['AdminDash@deleteScenery', $s->id]]) !!}
                                            @csrf
                                            {!! Form::hidden('_method', 'DELETE') !!}
                                            <button class="btn btn-danger simple-tooltip" data-toggle="tooltip"
                                                    action="submit" title="Delete Scenery"><i class="fas fa-times"></i>
                                            </button>
                                            {!! Form::close() !!}
                                        </div>
                                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="row">
                                        <div class="col-sm-3">
                                            <a href="/dashboard/admin/scenery/edit/{{ $s->id }}"
                                               class="btn btn-success simple-tooltip" title="Edit Scenery"><i
                                                    class="far fa-edit"></i></a>
                                        </div>
                                        <div class="col-sm-2">
                                            {!! Form::open(['action' => ['AdminDash@deleteScenery', $s->id]]) !!}
                                            <button class="btn btn-danger simple-tooltip" action="submit"
                                                    title="Delete Scenery"><i class="fas fa-times"></i></button>
                                            {!! Form::close() !!}
                                        </div>
                                    </div>
                                </td>
