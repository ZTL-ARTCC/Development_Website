...
<div class="container">
    <a class="btn btn-primary" href="/admin/roster"><i class="fa fa-arrow-left"></i> Back</a>
    <br><br>
    <div class="row">
        <div class="col-sm-2">
            <a class="btn btn-primary" href="/admin/rostertidy/<?=$pyr?>/<?=$pm?>"><i class="fa fa-arrow-left"></i> Previous Month</a></li>
        </div>
        <div class="col-sm-8">
            <center><h4><?=$mname?> 20<?=$year?></h4></center>
        </div>
        <div class="col-sm-2" align="right">
            <a class="btn btn-primary" href="/admin/rostertidy/<?=$nyr?>/<?=$nm?>">Next Month <i class="fa fa-arrow-right"></i></a>
        </div>
    </div>
    <br>
        ...
        <div role="tabpanel" class="tab-pane active" id="home">
            <table class="table table-striped">
                ...
                <tbody>
                    @foreach($homec as $c)
                        <tr>
                            <td><a href="/admin/roster/edit/{{ $c->id }}">{{ $c->backwards_name }} ({{ $c->id }})</a></td>
