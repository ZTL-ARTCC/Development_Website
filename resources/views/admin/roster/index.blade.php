							...
							<table id="home-table" class="table table-condensed">
								...
								<tbody>
									...
									<tr>
									    ...
									    <td>{{{$h->rating_long}}}</td>
									    <td>
											<a href="/admin/roster/edit/{{$h->id}}" style="display:inline-block" class="btn btn-success btn-xs simple-tooltip" title="Edit"><i class="fa fa-pencil-square-o"></i></a>
							...
							<table id="visit-table" class="table table-condensed">
								...
								<tbody>
									...
									<tr>
									    ...
									    <td>
									  		<a href="/admin/roster/edit/{{$v->id}}" style="display:inline-block" class="btn btn-success btn-xs simple-tooltip" title="Edit"><i class="fa fa-pencil-square-o"></i></a>
											@if(Auth::user()->can('roster_del'))
												@if($v->loa == 0)
