    ...
    <div class="content">
                    ...
                    <div class="block">
                            ...
                            <div class="block-options">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-left" x-placement="top-end"
                                         style="position: absolute; transform: translate3d(73px, -2px, 0px); top: 0px; left: 0px; will-change: transform;">
                        ...
                        <div class="block-content text-center">
                            <div class="py-20">
                                ...
                                <p class="font-size-lg">Roster Management</p>
                                <p>
                                </p></div>
                        </div>
                    </div>
                    ...
                    <div class="block">
                        ...
                        <div class="block-content text-center">
                            <div class="py-20">
                                ...
                                <p class="font-size-lg">Training Admin</p>
                                <p>
                                </p></div>
                        </div>
                    </div>
        ...
        <!-- END Training Admin -->
            ...
            @if(Auth::user()->can('staff'))
                <div class="col-md-4">
                    <a class="block block-link-shadow" href="/admin/announcements" target="_blank">
                        <div class="block-content text-center" style="height:215px;">
                            <div class="py-20" style="margin-top: 35px;">
                                ...
                                <p class="font-size-lg">Website Notices</p>
                                <p>
                                </p>
                            </div>
                        </div>
        ...
        <!-- END Website Notices -->
            ...
            @if(Auth::user()->can('staff'))
                <div class="col-md-4">
                    <a class="block block-link-shadow" href="/admin/send" target="_blank">
                        <div class="block-content text-center" style="height:215px;">
                            <div class="py-20" style="margin-top: 35px;">
                                <p class="h1 text-corporate-dark font-w600 mb-10"><i class="fa fa-envelope-open"></i>
                                </p>
                                <p class="font-size-lg">Bulk Email</p>
                                <p>
                                </p>
                            </div>
                        </div>
                    ...
                    <a class="block block-link-shadow" href="/admin/activitylog">
                        <div class="block-content text-center" style="height:215px;">
                            <div class="py-20" style="margin-top: 35px;">
                                ...
                                <p class="font-size-lg">Website Audit</p>
                                <p>
                                </p>
                            </div>
                        </div>
                    ...
                    <a class="block block-link-shadow" href="/admin/docs">
                        <div class="block-content text-center" style="height:215px;">
                            <div class="py-20" style="margin-top: 35px;">
                                ...
                                <p class="font-size-lg">Documents and Downloads</p>
                                <p>
                                </p>
                            </div>
                        </div>
                    ...
                    <a class="block block-link-shadow" href="/admin/feedback">
                        <div class="block-content text-center" style="height:215px;">
                            <div class="py-20" style="margin-top: 35px;">
                                ...
                                <p class="font-size-lg">Pending Feedback</p>
                                <p>
                                </p>
                            </div>
                        </div>
                    ...
                    <a class="block block-link-shadow" href="/admin">
                        <div class="block-content text-center" style="height:215px;">
                            <div class="py-20" style="margin-top: 35px;">
                                ...
                                <p class="font-size-lg">Scenery</p>
                                <p>
                                </p>
                            </div>
                        </div>
