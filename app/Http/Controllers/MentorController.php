...
class MentorController extends Controller {
    ...
    public function cancelSession($id) {
        ...
        $request->delete();
        return Redirect::to('dashboard.training.mentors.sessions')
                       ->with('message', 'Session canceled. Student has been notified!');
    }

    public function addNote() {
        $controller = User::where('status', '1')->where('canTrain', '1')->orderBy('lname', 'ASC')->get()
